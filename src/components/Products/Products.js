 ...
 let dataSearch = data.cardData.filter(item=>{
  ...
  return (
    ...
    <div className="card-container">
     ...
     /> 
     <h2 style={{marginLeft:"2em", marginTop:"3em"}}>You are a</h2>
     <select value={dropdown} onChange={handleDropdown} style={{marginLeft:"3em", width:"20em", height:"3em"}} > 
     ...
     <h2 style={{marginLeft:"2em", marginTop:"3em"}}>Price</h2>
     <select value={dropdown1} onChange={handleDropdown1} style={{marginLeft:"3em", width:"20em", height:"3em"}}> 
     ...
     <h2 style={{marginLeft:"2em", marginTop:"3em"}}> Camera</h2>
     <select value={dropdown2} onChange={handleDropdown2} style={{marginLeft:"3em", width:"20em", height:"3em"}}> 
